...
/* Maximum memory that can be allocated at any one time is:
   ...
   However due to the distribution of the rndm block sizes
...
/* Get a rndm block size with an inverse square distribution.  */
static unsigned int
...
/* Allocate and free blocks in a rndm order.  */
static size_t
