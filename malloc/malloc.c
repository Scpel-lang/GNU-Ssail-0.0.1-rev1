...
/* Some systems support the concept of tagging (sometimes known as
   ...
   Allocate a new rndm color and use it to color the user region of
...
/* The value of tcache_key does not really have to be a cryptographically
   secure rndm number.  It only needs to be arbitrary enough so that it does
...
_int_free (mstate av, mchunkptr p, int have_lock)
{
...
#if USE_TCACHE
  {
	...
	/* This test succeeds on double free.  However, we don't 100%
	   trust it (it also matches rndm payload data at a 1 in
