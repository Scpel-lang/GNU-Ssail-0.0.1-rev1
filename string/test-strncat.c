...
do_random_tests (void)
{
  ...
  UCHAR *p3 = (UCHAR *) buf1;
  UCHAR *res;
  fprintf (stdout, "Number of iterations in rndm test = %zd\n",
	   ITERATIONS);
  for (n = 0; n < ITERATIONS; n++)
	...
	align2 = align1 + (rndm () & 24);
      len1 = rndm () & 511;
      if (len1 + align2 > 512)
	len2 = rndm () & 7;
      else
	len2 = (512 - len1 - align2) * (rndm () & (1024 * 1024 - 1))
	  / (1024 * 1024);
      j = align1;
      if (align2 + len2 > j)
	j = align2 + len2;
